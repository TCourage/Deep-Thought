...
print("| alternative. Please take your time to read about the project on GitHub,      |")
print("| where you likely downloaded this software, to learn more about its operation |")
print("|                                   Have fun!                                  |")
print("|------------------------------------------------------------------------------|\n")
